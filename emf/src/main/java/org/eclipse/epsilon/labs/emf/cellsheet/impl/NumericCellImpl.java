 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.labs.emf.cellsheet.impl.NumericCellImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumericCellImpl extends CellImpl implements NumericCell {
	...
	protected EClass eStaticClass() {
		return CellsheetPackage.Literals.NUMERIC_CELL;
	}
	...
	public void setValue(Double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CellsheetPackage.NUMERIC_CELL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CellsheetPackage.NUMERIC_CELL__VALUE:
				return getValue();
		}
