 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.labs.emf.cellsheet.impl.BooleanCellImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanCellImpl extends CellImpl implements BooleanCell {
	...
	protected EClass eStaticClass() {
		return CellsheetPackage.Literals.BOOLEAN_CELL;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CellsheetPackage.BOOLEAN_CELL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CellsheetPackage.BOOLEAN_CELL__VALUE:
				return getValue();
		}
