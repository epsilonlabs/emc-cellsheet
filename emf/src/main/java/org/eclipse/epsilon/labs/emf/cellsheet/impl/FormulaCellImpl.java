 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.labs.emf.cellsheet.impl.FormulaCellImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FormulaCellImpl extends CellImpl implements FormulaCell {
	...
	protected EClass eStaticClass() {
		return CellsheetPackage.Literals.FORMULA_CELL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CellsheetPackage.FORMULA_CELL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CellsheetPackage.FORMULA_CELL__VALUE:
				return getValue();
		}
