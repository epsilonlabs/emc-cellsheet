 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.labs.emf.cellsheet.impl.BlankCellImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlankCellImpl extends CellImpl implements BlankCell {
	...
	protected EClass eStaticClass() {
		return CellsheetPackage.Literals.BLANK_CELL;
	}
	...
	public void setValue(Object newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CellsheetPackage.BLANK_CELL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CellsheetPackage.BLANK_CELL__VALUE:
				return getValue();
		}
