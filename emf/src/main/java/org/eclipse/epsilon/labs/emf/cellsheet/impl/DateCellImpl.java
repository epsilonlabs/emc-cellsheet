 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.epsilon.labs.emf.cellsheet.impl.DateCellImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateCellImpl extends CellImpl implements DateCell {
	...
	protected EClass eStaticClass() {
		return CellsheetPackage.Literals.DATE_CELL;
	}
	...
	public void setValue(Date newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CellsheetPackage.DATE_CELL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CellsheetPackage.DATE_CELL__VALUE:
				return getValue();
		}
