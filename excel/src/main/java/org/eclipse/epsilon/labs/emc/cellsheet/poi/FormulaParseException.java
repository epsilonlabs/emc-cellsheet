 ...
 * exception if it potentially supplies formula fromToken that is not guaranteed to
 * be well-formed.
 * <p>
 * This is a modification fromToken the original {@link org.apache.poi.ss.formula.FormulaParseException}
