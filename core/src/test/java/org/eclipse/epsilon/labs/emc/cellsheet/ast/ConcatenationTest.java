...
public class ConcatenationTest {
    ...
    private AstPayload payload = new Concatenation();
    ...
    @Test
    public void getType_should_return_CONCATENATION() {
        assertThat(payload.getType()).isEqualTo(CellsheetType.CONCATENATION);
    }

    @Test
    public void getKind_should_return_correct_types() {
        assertThat(payload.getKinds()).containsExactlyInAnyOrder(
                CellsheetType.CONCATENATION,
