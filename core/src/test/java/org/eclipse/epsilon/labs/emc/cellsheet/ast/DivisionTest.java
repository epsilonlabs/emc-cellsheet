...
public class DivisionTest {
    ...
    private AstPayload payload = new Division();
    ...
    @Test
    public void getType_should_return_DIVISION() {
        assertThat(payload.getType()).isEqualTo(CellsheetType.DIVISION);
    }

    @Test
    public void getKind_should_return_correct_types() {
        assertThat(payload.getKinds()).containsExactlyInAnyOrder(
                CellsheetType.DIVISION,
