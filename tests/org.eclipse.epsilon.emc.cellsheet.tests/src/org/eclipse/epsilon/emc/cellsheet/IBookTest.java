...
public class IBookTest {
  ...
  public void getTypeOf_should_throw_IllegalArgumentExcpetion_when_given_unsupported_object()
      throws Exception {
    book.getTypeOf(this);
  }
  ...
  @Test(expected = IllegalArgumentException.class)
  public void getTypeNameOf_should_throw_IllegalArgumentException_when_given_unsupported_object()
      throws Exception {
  ...
  public void isOfType_should_throw_EolModelElementTypeNotFoundException_when_given_bad_type()
      throws Exception {
