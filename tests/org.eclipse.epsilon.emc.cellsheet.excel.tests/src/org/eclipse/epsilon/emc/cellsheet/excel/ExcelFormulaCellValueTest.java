...
public class ExcelFormulaCellValueTest {
  ...
  @Test
  public void getFormulaTree_should_return_tree_with_1_operand_1_operator_when_sum_1_arg()
      throws Exception {
  ...
  @Test
  public void getFormulaTree_should_return_tree_with_5_operands_1_operator_when_sum_func_5_args()
      throws Exception {
    ...
    final Set<String> expected =
        new HashSet<>(Arrays.asList("Data!B1", "Data!D5", "Data!B5", "Data!D2", "Data!C2"));
