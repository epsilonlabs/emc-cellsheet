...
public class AiHlookup extends AbstractVar3or4ArgAiFunction {
	...
	public ValueEval evaluate(int srcRowIndex, int srcColumnIndex, ValueEval arg0, ValueEval arg1, ValueEval arg2,
		...
		try {
			// Evaluation order:
			// arg0 lookup_value, arg1 table_array, arg3 range_lookup, find lookup value,
			// arg2 row_index,
			// fetch result
			ValueEval lookupValue = OperandResolver.getSingleValue(arg0, srcRowIndex, srcColumnIndex);
			TwoDEval tableArray = LookupUtilsDelegate.resolveTableArrayArg(arg1);
			boolean isRangeLookup = LookupUtilsDelegate.resolveRangeLookupArg(arg3, srcRowIndex, srcColumnIndex);
