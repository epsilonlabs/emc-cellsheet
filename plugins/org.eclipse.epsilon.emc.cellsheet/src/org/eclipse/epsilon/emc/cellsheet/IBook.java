 ...
 * 
 * Book is analogous to a model in the Epsilon architecture. This was chosen to maintain the overall
 * Spreadsheet methodology.
 * 
 * Element ID's should be implemented as cell references where possible TODO: Determine correct way
 * to ID individual columns and rows
 * 
 * @author Jonathan Co
 *
 */
public interface IBook extends HasId, HasType, IModel, Iterable<ISheet> {
  ...
  @Override
  default boolean isOfType(Object obj, String typename)
