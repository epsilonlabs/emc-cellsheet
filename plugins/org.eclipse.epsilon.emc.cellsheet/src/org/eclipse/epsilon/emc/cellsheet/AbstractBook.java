 ...
 * 
 * Majority of methods delegate back to the original interface's default methods. Abstract class was
 * created to allow inheritance of default methods from the {@link Model}.
 * 
 * @author Jonathan Co
 *
 */
