...
public interface IFormulaTree extends HasType {
	...
	/**
	 * @return the original {@link IFormulaCellValue} that is this tree was
	 *         derived from.
	 */
	...
	/**
	 * @return the parent of this {@link IFormulaTree} or {@code null} if no
	 *         parent exists
	 */
	...
	/**
	 * @param index
	 *            the position of the child sub-tree
	 * @return The position of the child at the sub-tree or {@code null} if they
	 *         do not exist
	 */
	public IFormulaTree getChildAt(int index);

	/**
	 * Add a sub-tree to this {@link IFormulaTree} and assign {@code this} as
	 * the parent. If the sub-tree already has a parent this will be
	 * re-assigned.
	 * 
	 * @param child
	 */
